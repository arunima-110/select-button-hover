    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-8">
      <div className="space-y-8 text-center">
        ...
        >
          ...
          <div className="w-[24px] h-[24px] px-[6px] bg-slate-100 dark:bg-slate-800 rounded-[14px] hover:rounded-[4px] border-[1px] border-slate-300 dark:border-slate-700 flex justify-center items-center group/badge relative cursor-pointer hover:bg-white dark:hover:bg-slate-700 transition-colors">
